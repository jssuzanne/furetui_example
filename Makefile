...
build-assets: ## build js and scss assets for production
	npm update
	npm run build
	rm -rfv furetui_exemple/team/static/furetui
	mv dist furetui_exemple/team/static/furetui
...
lint: ## check style with flake8
	flake8 furetui_exemple
	npm run lint

test: ## run tests
	ANYBLOK_CONFIG_FILE=app.test.cfg py.test -v -s furetui_exemple
	npm run test:unit
